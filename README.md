...
**[WEBPACK Project]**
  The Leader board project is a project created using html, css and javascript modules with Es6 and  with Webpack installed in it for the better performance while in develpment even in production mode, because all functionality are emprimented in here. This LeaderBoard is an Advanced one that Working with Api  for file enterchangable and best practice in using ES6.
